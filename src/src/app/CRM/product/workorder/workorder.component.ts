...
export class WorkOrderComponent implements OnInit {
    ...
    getData() {
        this._eCRMFSService.getCustomers('workorder')
            .subscribe(members => {
    ...
    getFilterData(filter) {
        this._eCRMFSService.getFilterCustomers('workorder', filter)
            .subscribe(members => {
                this.members = members;
                this.dataSource = new MatTableDataSource(members);
                this.dataSource.paginator = this.paginator;
    ...
    setData(data: any) {
        return this._eCRMFSService.setCustomer('workorder',data);
    }
    ...
    getCustomerDoc(docId) {
        this.myCustID = docId;
        this.myDocData = this._eCRMFSService.getCustomerDoc('workorder', docId);
        this.customerForm.reset();
        this.toggle('editMode');
    }
    deleteCustomerDoc(docId) {
        if (confirm("Are you sure want to delete this record ?")) {
            this.myDocData = this._eCRMFSService.deleteCustomerDoc('workorder', docId);
        }
    }
    updateCustomerDoc(docId, formData) {
        this.myDocData = this._eCRMFSService.updateCustomerDoc('workorder', formData, docId);
        this.customerForm.reset();
        this.toggle('resMode');
    }
